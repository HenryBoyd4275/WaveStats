...
import { Form, FormField, Button, Text, Box, RadioButtonGroup } from "grommet";
...
export default function WindForm(props) {
  ...
  function windSubmit(inputValues) {
    ...
    const windSpeedAtTenMetres =
      ...
      Math.pow(10 / inputValues.heightOfWindMeasure, getWindPow());
    const height =
      "" +
      Math.round(
    ...
    props.onSubmit({
      ...
      increment: inputValues.increment,
    });
  }
